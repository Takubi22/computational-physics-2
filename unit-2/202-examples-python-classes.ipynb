{
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "obj2 = Student([\"Mike\", \"Mike2\"], {9.2, 8.9})\n",
    "\n",
    "#print(obj2)\n",
    "\n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "[<__main__.Student object at 0x10655b0d0>, <__main__.Student object at 0x10655b070>, <__main__.Student object at 0x10655b0a0>, <__main__.Student object at 0x10655b160>, <__main__.Student object at 0x10655b1f0>, <__main__.Student object at 0x10655b250>, <__main__.Student object at 0x10655b2b0>, <__main__.Student object at 0x10655b310>, <__main__.Student object at 0x10655b370>, <__main__.Student object at 0x10655b3d0>, <__main__.Student object at 0x10655b430>, <__main__.Student object at 0x10655b490>]\n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "[<__main__.Student object at 0x10655b070>, <__main__.Student object at 0x10655b0d0>, <__main__.Student object at 0x10655b0a0>, <__main__.Student object at 0x10655b160>, <__main__.Student object at 0x10655b1f0>, <__main__.Student object at 0x10655b250>, <__main__.Student object at 0x10655b2b0>, <__main__.Student object at 0x10655b310>, <__main__.Student object at 0x10655b370>, <__main__.Student object at 0x10655b3d0>, <__main__.Student object at 0x10655b430>, <__main__.Student object at 0x10655b490>]\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 148,
   "id": "41e56626-b5e5-4280-b7bb-b7f7271d84ad",
   "metadata": {},
   "outputs": [],
   "source": [
    "import numpy as np"
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 149,
   "id": "b963ec9d-f103-494d-9c17-8f4bff450bca",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 164,
   "id": "0af6e598-cf7f-4a71-98c7-283b16d853fa",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "source": [
    ...
    "    flush.append(Card(suit = 3, rank=randomList[i]))"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "        print(\"Welcome, we are initialising the class.\")\n",
    "        self.x = x\n",
    "        self.y = y\n",
    "        \n",
    "    def __str__(self):\n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Welcome, we are initialising the class.\n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     ...
     "text": [
      "in __add__\n",
      "we don't know how to add a <class 'int'> to a Vector\n"
     ]
    },
    {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "44f4ede1-6223-4504-ae47-f1e0257b54bf",
   "metadata": {},
   "outputs": [],
   "source": []
  }
